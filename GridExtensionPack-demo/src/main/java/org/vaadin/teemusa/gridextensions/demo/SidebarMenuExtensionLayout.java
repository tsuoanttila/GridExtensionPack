...
public class SidebarMenuExtensionLayout extends VerticalLayout {
    ...
    public SidebarMenuExtensionLayout() {
        ...
        addButton.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                Command command = new Command() {
                    ...
                    @Override
                    public void trigger() {
                        labelLayout.addComponent(new Label("Command "
                                + commandId + " clicked!"), 0);
                    }
                };
        ...
        removeButton.addClickListener(new Button.ClickListener() {
            @Override
            public void buttonClick(ClickEvent event) {
                Command command = commands.get(Double.valueOf(
                        Math.ceil(commands.size() / 2)).intValue());
        ...
        styleButton.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                if (commands.size() > 0) {
                    ...
                    setStyle(Double.valueOf(Math.ceil(commands.size() / 2))
                            .intValue(), "red");
                    setStyle(0, "blue");
            ...
            private void setStyle(int index, String style) {
                ...
                while ("divider".equals(extension.getStyle(command))
                        && (commands.size() - 1) > index) {
                    ++index;
